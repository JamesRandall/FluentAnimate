...
namespace FluentAnimateSample
{
    public class MyViewController : UIViewController
    {
        ...
        {
            FluentAnimate.EaseIn(0.5, () => _button.Center = new PointF(ButtonWidth/2, ButtonHeight/2))
                .ThenEaseInOut(() => _button.Center = new PointF(ButtonWidth/2, View.Bounds.Height - ButtonHeight/2))
                .ThenEaseOut(() => _button.Center = new PointF(View.Bounds.Width - ButtonWidth / 2, View.Bounds.Height - ButtonHeight / 2))
                .ThenLinear(() => _button.Center = new PointF(View.Bounds.Width - ButtonWidth / 2, ButtonHeight / 2))
                .Repeat()
                .Start();
        }
    }
